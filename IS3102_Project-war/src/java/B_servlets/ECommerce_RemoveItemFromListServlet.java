...
public class ECommerce_RemoveItemFromListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String[] checkedDelArr = request.getParameterValues("delete");
            ArrayList<ShoppingCartLineItem> shoppingCart = (ArrayList<ShoppingCartLineItem>) (session.getAttribute("shoppingCart"));
            ShoppingCartLineItem item = new ShoppingCartLineItem();
            
            for(String sku : checkedDelArr){
                item.setSKU(sku);
            ...
            response.sendRedirect("/IS3102_Project-war/B/SG/shoppingCart.jsp?goodMsg=Item has been removed!");
