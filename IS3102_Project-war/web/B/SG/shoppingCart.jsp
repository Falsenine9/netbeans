                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px">
                                                                <input type="text" class="input-text text " title="cardno" name="cardNo" pid="txtCardNo" regex="^(?5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}$" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 5px">
